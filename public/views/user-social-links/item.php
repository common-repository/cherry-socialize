...
<li class="<?php echo esc_attr( $config['base_class'] ); ?>__item">
	<a class="<?php echo esc_attr( $config['base_class'] ); ?>__link <?php echo esc_attr( $config['base_class'] ); ?>__link--<?php echo esc_attr( $id ); ?>" href="<?php echo htmlentities( $social_url ); ?>" target="_blank">
